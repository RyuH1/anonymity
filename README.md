...
The code for the front-end providing the interface for voting through the Geode is in `./front-end`. It's built on top of the [Polkadot Assembly](https://github.com/Premiurly/polkassembly)
