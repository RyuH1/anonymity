  ...
  return (
    <div className={className}>
      ...
      <div className="signal-bar">
        {[...Array(ayeSignals)].map((e, i) => (
          <div className="aye" key={i} />
        ))}
        {[...Array(notSignaled)].map((e, i) => (
          <div className="not-signaled" key={i} />
        ))}
        {[...Array(naySignals)].map((e, i) => (
          <div className="nay" key={i} />
        ))}
      </div>
    </div>
  )
