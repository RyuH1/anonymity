...
const IdentityBadge = ({
  ...
  const popupContent = (
    <StyledPopup>
      ...
      {flags?.isCouncil && (
        <li>
          <span className="desc">Council member</span>
          <CouncilEmoji />
        </li>
      )}
    </StyledPopup>
  ...
  return (
    <div className={className}>
      <Popup trigger={infoElem} content={popupContent} hoverable={true} position="top center" />
    </div>
  )
}
...
export default styled(IdentityBadge)`
  ...
  i.green.circle.icon {
    color: ${({ theme }) => theme.colors.green_primary} !important;
  }
