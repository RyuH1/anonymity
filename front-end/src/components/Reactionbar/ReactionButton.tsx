...
export interface ReactionButtonProps {
  ...
  refetch?: (
    ...
    | Promise<ApolloQueryResult<PostReactionsQuery>>
...
const ReactionButton = function ({
  ...
  return userNames.length > 0 ? <Popup content={popupContent} trigger={button} /> : button
}

export default styled(ReactionButton)`
  .social {
    color: ${({ theme }) => theme.colors.blue_primary} !important;
    font-size: 1em !important;
  }

  .reacted {
    background-color: ${({ theme }) => theme.colors.blue_secondary} !important;
