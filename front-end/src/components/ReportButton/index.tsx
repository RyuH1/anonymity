...
const ReportButton = function ({ type, contentId }: DiscussionProps) {
  ...
  const onReasonChange = (event: React.SyntheticEvent<HTMLElement, Event>, data: DropdownProps) =>
    setReason(data.value?.toString() || '')
  const onCommentsChange = (event: React.FormEvent<HTMLTextAreaElement>, data: TextAreaProps) =>
    setComments(data.value?.toString() || '')
  ...
  return (
    <>
        ...
        <Modal
          buttons={
            <Form.Group>
              ...
              />
              <Button content="Close" icon="close" secondary onClick={dismissModal} />
            </Form.Group>
          }
          centered
          dimmer="inverted"
          ...
          <Form standalone={false}>
            ...
            <Form.Group>
              <Form.Field width={16}>
                ...
                <TextArea name={'comments'} onChange={onCommentsChange} value={comments || ''} />
              </Form.Field>
            </Form.Group>
      ...
      <Button className={'social'} onClick={openModal}>
        <Icon name="flag" />
        {' Report'}
      </Button>
    </>
