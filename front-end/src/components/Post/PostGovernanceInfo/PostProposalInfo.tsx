...
const PostProposalInfo = ({ onchainLink }: Props) => {
  ...
  const { onchain_proposal: onchainProposal, proposer_address: proposerAddress } = onchainLink
    ...
    <OnchainInfoWrapper>
      ...
      <Grid>
        ...
        {depositAmount && currentNetwork && (
          <Grid.Column mobile={16} tablet={8} computer={8}>
            <h6>Deposit</h6>
            {parseInt(depositAmount) / Math.pow(10, chainProperties[currentNetwork].tokenDecimals) +
              ' ' +
