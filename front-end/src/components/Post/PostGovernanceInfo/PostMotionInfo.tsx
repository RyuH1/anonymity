...
const PostMotionInfo = ({ className, onchainLink }: Props) => {
  ...
  const { onchain_motion: onchainMotion, proposer_address: proposerAddress } = onchainLink
            ...
            {motionProposalArguments && motionProposalArguments.length ? (
              <>
                ...
                {motionProposalArguments.map((element, index) => {
                  return (
                    <div className={'methodArguments'} key={index}>
                      <span key={index}>
...
const TreasuryInfo = ({
  ...
  treasurySpendProposal?: OnchainLinkMotionTreasuryFragment | null
}) => {
