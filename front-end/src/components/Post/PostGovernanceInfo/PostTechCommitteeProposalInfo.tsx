...
const PostTechCommitteeProposalInfo = ({ className, onchainLink }: Props) => {
  ...
  const { metaDescription, memberCount, method, proposalArguments, proposalHash, preimage } =
    onchainTechCommitteeProposal[0]
  ...
  return (
    <OnchainInfoWrapper className={className}>
      ...
      <Grid>
        ...
        <Grid.Column mobile={16} tablet={16} computer={16}>
          <ExternalLinks
            isTechCommitteeProposal={true}
            onchainId={onchainLink.onchain_tech_committee_proposal_id}
          />
        </Grid.Column>
      </Grid>
    </OnchainInfoWrapper>
