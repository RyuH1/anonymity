    ...
    <div className={className}>
      ...
      <Grid stackable reversed="mobile tablet">
        <Grid.Column mobile={16} tablet={16} computer={10}>
          ...
          <Link className="full-listing-link" to="referenda">
        ...
        <Grid.Column mobile={16} tablet={16} computer={6}>
          <InfoBox
            ...
            content="This is the place to discuss on-chain proposals, referenda, motions, tips, bounties, treasury proposals and technical committee proposals. On-chain posts are automatically generated as soon as they are created on the chain. Only the proposer is able to edit them."
            name="onchainInfo"
