...
import {
  useSetCredentialsConfirmMutation,
  useSetCredentialsStartMutation
        ...
        <Modal
          buttons={
            <Form.Group>
              ...
              />
              <Button content="Close" secondary onClick={dismissModal} />
            </Form.Group>
          }
          className={className}
          centered
              ...
              <>
                ...
                <Form.Group>
                  <Form.Field width={16}>
                    ...
                    />
                    {errors.email && (
                      <span className={'errorText'}>{messages.VALIDATION_EMAIL_ERROR}</span>
                    )}
                  </Form.Field>
                </Form.Group>
                <Form.Group>
